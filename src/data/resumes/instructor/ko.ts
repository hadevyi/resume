...
export const instructorKo = {
    ...
    profile: {
      ...
      summary:
        '현업 개발과 프로젝트 코칭 경험을 바탕으로 학습자가 개념을 직접 구현하고 결과물로 연결할 수 있도록 돕습니다.\n강의에서는 기술 설명에 그치지 않고 프로젝트 수행, 이력 정리, 협업 흐름까지 함께 다룹니다.',
    ...
    highlights: [
      ...
      },
      {
        ...
        description:
          '자료구조와 알고리즘 파트를 맡아 개념과 구현 흐름을 연결해 강의합니다.'
      },
      {
        ...
        items: [
          {
            ...
            details: ['프로젝트 방향을 정하고 개발자 커리어를 상담']
          },
          {
            period: '2025.11',
            title: 'SW중심대학 개방형 온라인 강좌',
            description: 'SW중심대학 | SW 개발자를 꿈꾸는 후배들에게',
            details: ['개발자 성장, 학습 방법, 커리어 준비를 7강으로 구성해 강의']
          },
          {
            period: '2025.09',
            title: '현직자 특강',
            description: '미래동양대학교 | 개발 커리어 디자인하기',
            details: ['전공 동아리 학생들에게 회사 선택 기준과 성장 방향을 정리해 설명']
          },
          {
            period: '2025.09 - 2025.10',
            title: '취업준비 서류정리 멘토링',
            description: '인제대학교 | 산학연프로젝트 4학년 대상',
            details: ['2개 팀의 프로젝트 경험을 이력서와 포트폴리오 목적에 맞게 재구성할 수 있도록 피드백']
          },
          {
            period: '2025.03 - 2028.02',
            title: '제로베이스 백엔드 스쿨 파트 강사',
          ...
          },
          {
            ...
            details: ['5인 팀의 기존 프로젝트를 단계별 산출물 기준으로 점검하고 설계·테스트 문서를 보완']
          },
          {
            period: '2025.01 - 2025.02',
            title: 'Git 토이프로젝트 멘토링',
            description: '인제대학교 | 산학연프로젝트 Git 협업 실습',
            details: ['정기 세션과 GitHub 댓글·PR 리뷰를 병행해 실습 중 생긴 질문에 답하고 피드백']
          },
          {
            period: '2024.02 - 2024.03',
            title: '현직자 멘토링',
            description: '인제대학교 | SW중점대 프로젝트 피드백',
            details: ['학생 프로젝트 결과물의 개선 방향과 개발자 진로를 함께 안내']
          },
          {
            period: '2023.09',
            title: '선배와의 만남 강연',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: '계약 프리랜서 · 6기·7기 교육생 대상 SW 개발 및 프로젝트 코칭, 신규 코치 OJT'
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: '과학기술정보통신부 | 재학 중 우수자 대상 2년 지원 유형, 4개 학기 전액 학비 지원'
          }
        ]
      },
      {
        ...
        items: [
          {
            period: '2025.08 - 현재',
            title: '오픈소스 기여모임 운영진',
            description: '오픈소스 기여모임 | 참여자의 오픈소스 탐색과 기여 흐름을 돕는 운영진으로 활동'
          },
          {
            period: '2022.12 - 현재',
            title: '비영리 IT 동아리 DND 개발운영진',
            description: 'DND | 개발 파트를 운영하고 프로젝트 피드백과 팀 활동 흐름을 관리'
          }
        ]
      }
    ]
